...
import com.cocoa.mvideoplayer.VedioTextureView;
...
public abstract class TextureRenderView extends FrameLayout implements TextureView.SurfaceTextureListener {

    //native绘制
    protected Surface mSurface;

    //渲染控件
    protected VedioTextureView mTextureView;
    ...
    protected void addTextureView() {
        ...
        mTextureView = null;
        mTextureView = new VedioTextureView(getContext());
