...
import com.cocoa.enviews.ENDownloadView;
import com.cocoa.enviews.ENPlayView;
...
import com.cocoa.mvideoplayer.utils.NetworkUtils;
...
public class StandardVideoPlayer extends VideoPlayer {
    ...
    public void startPlayLogic() {
        if (mStandardVideoAllCallBack != null) {
            ...
            mStandardVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, StandardVideoPlayer.this);
        }
        prepareVideo();
