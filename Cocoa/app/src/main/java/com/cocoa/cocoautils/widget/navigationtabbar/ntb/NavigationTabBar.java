...
package com.cocoa.cocoautils.widget.navigationtabbar.ntb;
...
import com.cocoa.cocoautils.widget.navigationtabbar.behavior.NavigationTabBarBehavior;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    public NavigationTabBar(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        try {
            ...
            setTitleSize(
                    typedArray.getDimension(R.styleable.NavigationTabBar_ntb_title_size, -2f)
            );
            ...
            setBadgeSize(
                    typedArray.getDimension(R.styleable.NavigationTabBar_ntb_badge_size, -2f)
            );
            setBadgePosition(
                    typedArray.getInt(
