...
import com.cocoa.cocoautils.utils.ColorUtils;
...
public class SwitchButton extends CompoundButton {
	...
	public void setBackColorRes(int backColorRes) {
		setBackColor(ColorStateList.valueOf(backColorRes));
//		setBackColor(ContextCompat.getColorStateList(getContext(), backColorRes));
	...
	public void setThumbColorRes(int thumbColorRes) {
		ColorStateList colorStateList = ColorStateList.valueOf(thumbColorRes);
		mThumbColor = colorStateList;
		if (mThumbColor != null) {
			setThumbDrawable(null);
		}
