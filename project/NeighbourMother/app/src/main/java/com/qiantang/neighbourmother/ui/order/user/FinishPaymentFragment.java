 ...
 * date: 2016/9/26.
 */
public class FinishPaymentFragment extends BaseFragment implements View.OnClickListener {
    ...
    public int getContentView() {
        return R.layout.fragment_finish_payment;
    }
    ...
    private void getHttpData(boolean isFirst, boolean isShowProgress, int what) {
        ...
        new UserOrderListHttp(getParentFragment().getActivity(), handler, 3,count, what, isShowProgress);
    }
        ...
        deleteOrderDialog.setOnSureListener(new DeleteOrderDialog.DeleteOrderListener() {
            ...
            public void onSure() {
                if (!TextUtils.isEmpty(userOrderListResp.getOrder_id())) {
                    ...
                    new UserDeleteOrderHttp(getParentFragment().getActivity(), handler, true, userOrderListResp.getOrder_id(), 3, true);
                }
...
//                orderAdapter.setDelete(isDelete);
    ...
    private void setData(List<UserOrderListResp> userOrderListResps, boolean isFirst) {
        ...
        if (userOrderListResps != null && userOrderListResps.size() > 0) {
            ...
            ToastUtils.toastshort(getParentFragment().getActivity(), isFirst == true ? getString(R.string.app_pull_not_data) : getString(R.string.app_pull_already_last_page));
        }
        orderAdapter.notifyDataSetChanged();
        listview.aotuRefreshComplete();
...
//    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        AppLog.D("FinishPaymentFragment.onActivityResult.resultCode:" + resultCode);
