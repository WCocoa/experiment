 ...
 */
public class AccountPayHttp extends BaseHttp {
    private Handler handler;
    private int what;
    private OrderPayReq orderPayReq;

    public AccountPayHttp(Context context, Handler handler, OrderPayReq orderPayReq, int what) {
    ...
    String getPrimaryUrl() {
        return API.ACCOUNT_SURPLUS_PAY;
    }
