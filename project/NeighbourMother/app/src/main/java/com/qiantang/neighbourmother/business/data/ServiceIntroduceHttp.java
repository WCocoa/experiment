...
public class ServiceIntroduceHttp extends BaseHttp {
    ...
    public ServiceIntroduceHttp(Context context, Handler handler, int position,int what, boolean isShowProgress) {
    ...
    String getPrimaryUrl() {
        return API.SERVICE_INTRODUCE + "?id=" + position;
    }
}
