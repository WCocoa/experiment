...
public class OrderAdapter extends BaseAdapter {
    private ArrayList<AttacheOrderListResp> list = new ArrayList<AttacheOrderListResp>();
    private LayoutInflater mLayoutInflater;
    private Activity       context;
    private int            type;
    private Handler        handler;

    public OrderAdapter(Activity context, int type, Handler handler) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.order_time = (TextView) convertView.findViewById(order_time);
        ...
        final AttacheOrderListResp item = list.get(position);
//        if (isDelete) {
...
//        }
        ...
        switch (item.getOrder_status()) {
            ...
            case 2:
                ...
                break;
            case 3:
                holder.payment_status.setText(R.string.already_schedule);
...
//                    setOrder_id(attacheOrderListResp.getOrder_id());
//                    new UserDeleteOrderHttp(context, handler, API.ATTACHE_ORDER_DELETE, attacheOrderListResp.getOrder_id(), 3, true);
//                } else {
//                    isDelete = false;
