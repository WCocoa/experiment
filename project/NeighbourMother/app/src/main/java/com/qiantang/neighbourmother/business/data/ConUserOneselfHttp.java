...
public class ConUserOneselfHttp extends BaseHttp {
    ...
    public ConUserOneselfHttp(Context context, Handler handler, int offset,int what, boolean isShowProgress) {
...
//        }.getType());
    ...
    String getPrimaryUrl() {
        return API.USER_ONE_SELF_INFO + "?count=" + API.COUNT + "&offset="+offset;
    }
}
