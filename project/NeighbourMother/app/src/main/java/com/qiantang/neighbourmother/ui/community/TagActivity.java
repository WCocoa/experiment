...
//        tagListView.setTags(bbsTagUtil.getmTags());
    ...
    public void initEvent() {
        ...
        tagListView.setTagCountListener(new TagListView.TagCountListener() {
            @Override
            public void acount(int acount) {
                top_tv.setText("请选择您喜欢的标签("+acount+"/3)");
//                请选择您喜欢的标签(0/3)
            }
        });
    }
...
//                if(tags.size()==0){
//                    ToastUtils.toastLong(this,R.string.tag_please_choose_title);
//                }else{
//
//                }
