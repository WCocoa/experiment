 ...
 * date: 2016/9/22.
 */
public class ChoiceServiceWeekendAdapter extends BaseAdapter {
    private ArrayList<DowOrSerChildObj> list = new ArrayList<>();
    private LayoutInflater mLayoutInflater;
    private Activity context;
    private Handler handler;

    public ChoiceServiceWeekendAdapter(Activity context, ArrayList<DowOrSerChildObj> list, Handler handler) {
