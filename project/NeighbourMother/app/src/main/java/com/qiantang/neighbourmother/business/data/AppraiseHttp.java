...
public class AppraiseHttp extends BaseHttp {
    private Handler handler;
    private int what;
    private PosterAppraiseReq posterAppraiseReq;

    public AppraiseHttp(Context context, Handler handler, PosterAppraiseReq posterAppraiseReq, int what) {
        this.context = context;
        this.handler = handler;
        this.what = what;
        this.posterAppraiseReq = posterAppraiseReq;
        start();
    }

    private void start() {

        String params = new Gson().toJson(posterAppraiseReq);
        AppLog.D("url:" + getUri());
    ...
    String getPrimaryUrl() {
        return API.CONMMUNITY_APPRAISE;
    }
