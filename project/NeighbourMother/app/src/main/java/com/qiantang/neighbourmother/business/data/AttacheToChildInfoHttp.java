 ...
 */
public class AttacheToChildInfoHttp extends BaseHttp {
	private Handler handler;
	private int what;
	private String child_id;
	public AttacheToChildInfoHttp(Context context, Handler handler,String child_id, int what) {
	...
	String getPrimaryUrl() {
		return API.ATTACHE_ORDER_TO_CHILD_INFO + "?child_id=" + child_id;
	}
