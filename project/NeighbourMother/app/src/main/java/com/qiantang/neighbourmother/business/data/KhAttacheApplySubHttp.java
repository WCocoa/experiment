 ...
 * 看护专员申请提交
 */
public class KhAttacheApplySubHttp extends BaseHttp {
	private Handler handler;
	private int what;
	private ApplyAttacheQuResp jsAttacheApplySubReq;
	public KhAttacheApplySubHttp(Context context, Handler handler, ApplyAttacheQuResp jsAttacheApplySubReq, int what) {
...
//		sendHandler(handler,null,what);
	...
	String getPrimaryUrl() {
		return API.ATTACHE_APPLY_KH+"?type=2";
	}
