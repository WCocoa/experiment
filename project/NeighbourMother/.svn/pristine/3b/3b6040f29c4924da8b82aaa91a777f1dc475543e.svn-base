 ...
 * @since 2015/9/29
 */
public class OptionPickerX extends WheelPicker {
     ...
     */
    public OptionPickerX(Activity activity, String[] options) {
        super(activity);
        this.options.addAll(Arrays.asList(options));
    }

    public OptionPickerX(Activity activity, ArrayList<String> options) {
        super(activity);
