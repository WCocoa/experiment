...
public class FinishPaymentFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void initData() {
        orderAdapter = new OrderAdapter(getParentFragment().getActivity(), 3, handler);
    ...
    private void getHttpData(boolean isFirst, boolean isShowProgress, int what) {
        ...
        new AttacheOrderListHttp(getParentFragment().getActivity(), handler,count ,3, what, isShowProgress);
    }
