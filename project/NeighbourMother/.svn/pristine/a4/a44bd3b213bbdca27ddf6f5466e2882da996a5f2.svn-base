...
public class ChoiceServiceActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        ser_label1=(TextView)findViewById(R.id.ser_label1);
        ser_label2=(TextView)findViewById(R.id.ser_label2);
        ser_label3=(TextView)findViewById(R.id.ser_label3);
        ser_label4=(TextView)findViewById(R.id.ser_label4);
        ser_label5=(TextView)findViewById(R.id.ser_label5);
    }
...
//        AppLog.D("phase:"+phase);
        ...
        choiceServLogic.setSer_label1(ser_label1);
        choiceServLogic.setSer_label2(ser_label2);
        choiceServLogic.setSer_label3(ser_label3);
        choiceServLogic.setSer_label4(ser_label4);
        choiceServLogic.setSer_label5(ser_label5);
