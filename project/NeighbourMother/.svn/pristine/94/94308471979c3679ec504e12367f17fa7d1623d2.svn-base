...
//        }
    ...
    private void setText(UserInfoResp userInfoResp) {
        display(person_headimg, APIConfig.BASE_IMG_URL + userInfoResp.getUser_avatar(), R.mipmap.default_img);
...
//        String arr[] = userInfoResp.getPic_environment();
        educationImages = new ArrayList<String>();
        createEnvironmentImage(userInfoResp.getPic_environment());
        plate_number.setText(userInfoResp.getCar_number());
        display(vehicle_image, APIConfig.BASE_IMG_URL + userInfoResp.getCar_pic(), R.mipmap.default_img);
        ...
        if (TextUtils.isEmpty(userInfoResp.getPic_teacher())) {
            rl_teacher_certification.setVisibility(View.GONE);
        } else {
            rl_teacher_certification.setVisibility(View.VISIBLE);
            educationImages.add(userInfoResp.getPic_teacher());
            display(teacher_certification_img, APIConfig.BASE_IMG_URL + userInfoResp.getPic_teacher(), R.mipmap.default_img);
        }
        if (TextUtils.isEmpty(userInfoResp.getPic_education())) {
            rl_education_certification.setVisibility(View.GONE);
        } else {
            rl_education_certification.setVisibility(View.VISIBLE);
            display(education_certification_img, APIConfig.BASE_IMG_URL + userInfoResp.getPic_education(), R.mipmap.default_img);
            educationImages.add(userInfoResp.getPic_education());
        }
//        display(teacher_certification_img, APIConfig.BASE_IMG_URL + userInfoResp.getPic_teacher(), R.mipmap.default_img);
//        display(education_certification_img, APIConfig.BASE_IMG_URL + userInfoResp.getPic_education(), R.mipmap.default_img);
...
//                    break;
                case 6:
                    intent.putExtra(IntentFinal.INTENT_IMGURL_TO_PHOTOVIEWACTIVITY, APIConfig.BASE_IMG_URL + userInfoResp.getCar_pic());
                    break;
                case 7:
                    intent.putExtra(IntentFinal.INTENT_IMGURL_TO_PHOTOVIEWACTIVITY, APIConfig.BASE_IMG_URL + userInfoResp.getUser_avatar());
                    break;
            }
...
//                break;
    ...
    private void clickEducation_image(List<String> imgs, int index) {
