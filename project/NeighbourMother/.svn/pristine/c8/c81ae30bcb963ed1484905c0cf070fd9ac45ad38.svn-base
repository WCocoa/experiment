 ...
 * date: 2016/9/22.
 */
public class ChoiceServiceNurseAdapter extends BaseAdapter {
    private ArrayList<DowOrSerChildObj> list = new ArrayList<>();
    private LayoutInflater mLayoutInflater;
    private Activity context;
    private Handler handler;

    public ChoiceServiceNurseAdapter(Activity context, ArrayList<DowOrSerChildObj> list, Handler handler) {
