...
public final static int RESULT_CODE_REFRESH=10;
public final static int RESULT_CODE_NOT_CHANGE=11;
    ...
    private void topTabStatusChange(int i) {
        ...
        switch (i) {
            case 1:
                waitPaymentFragment.setRefresh(true);
                ...
                break;
            case 2:
                underwayPaymentFragment.setRefresh(true);
                ...
                break;
            case 3:
                finishPaymentFragment.setRefresh(true);
