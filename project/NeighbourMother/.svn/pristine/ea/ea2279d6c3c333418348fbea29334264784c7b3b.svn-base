...
public class AttacheOrderChildrenInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initData() {
        ...
        String child_id = getIntent().getStringExtra(IntentFinal.INTENT_ATTACHE_ORDER_DETAILS_TO_CHILDREN_INFO);
        new AttacheToChildInfoHttp(this, handler, child_id, 1);
    }
