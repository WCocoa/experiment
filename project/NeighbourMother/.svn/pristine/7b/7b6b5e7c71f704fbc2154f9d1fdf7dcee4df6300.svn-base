...
//            // 延迟一秒后执行，让overlay为不可见
    ...
    private void initDistrict(final LocInfoObj cityObj){
        ...
        optionPickerX.setOnOptionPickListener(new OptionPickerX.OnOptionPickListener() {
            ...
            public void onOptionPicked(int position, String option) {
                ...
                PDistrictObj pDistrictObj=cityOperation.getDistrictId(option,String.valueOf(cityObj.getCity_id()));
                AppLog.D("pDistrictObj1:"+pDistrictObj.getAreaName());
                AppLog.D("pDistrictObj2:"+pDistrictObj.getAreaId());
                AppLog.D("option:"+pDistrictObj.getAreaName());
                AppLog.D("option:"+pDistrictObj.getAreaId());
