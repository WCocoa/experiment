 ...
 * 看护专员申请提交
 */
public class ZcAttacheApplySubHttp extends BaseHttp {
    private Handler handler;
    private int what;
    private ApplyAttacheQuResp jsAttacheApplySubReq;

    public ZcAttacheApplySubHttp(Context context, Handler handler, ApplyAttacheQuResp jsAttacheApplySubReq, int what) {
    ...
    String getPrimaryUrl() {
        return API.ATTACHE_APPLY_ZC + "?type=4";
    }
