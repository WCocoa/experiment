 ...
 * date: 2016/9/22.
 */
public class ChoiceServiceSubItemAdapter extends BaseAdapter {
    private ArrayList<DowOrSerChildObj> list = new ArrayList<>();
    private LayoutInflater mLayoutInflater;
    private Activity context;
    private Handler handler;

    public ChoiceServiceSubItemAdapter(Activity context, ArrayList<DowOrSerChildObj> list, Handler handler) {
...
//            holder.rb_check.setChecked(cell.isChecked());
//        } else {
...
//        }
    ...
    public void selectPosition(int position, boolean isChanged, int state, int status) {
