...
/**
 * ClassName:专员开始服务请求接口
 * author: Cocoa
 * date: 2016/9/28.
 */

public class AttacheOrderStartHttp extends BaseHttp {
    private Handler handler;
    private int what;
    private boolean isShowProgress;
    private String orderId;

    public AttacheOrderStartHttp(Context context, Handler handler, String orderId, int what, boolean isShowProgress) {
    ...
    String getPrimaryUrl() {
        return API.ATTACHE_ORDER_DETAILS_START;
    }
