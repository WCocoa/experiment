...
public class AttacheOrderAcceptHttp extends BaseHttp {
    ...
    public AttacheOrderAcceptHttp(Context context, Handler handler, String orderId, int what, boolean isShowProgress) {
    ...
    String getPrimaryUrl() {
        return API.ATTACHE_ORDER_DETAILS_ACCEPT;
    }
