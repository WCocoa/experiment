...
public class PosterDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        praise_image = (ImageView) findViewById(R.id.praise_image);
        loadHeadView();
    }
...
if(!urlIsLoad)
                ...
                praise_image.setSelected(posterDetailResp.getPost().getLiked() == 1);
    ...
    private void showDialog() {
        if (sharedDialog == null) {
            ...
            bundle.putSerializable(IntentFinal.INTENT_CONMMUNITY_SHARE_OBJ,
                    new ShareObj(posterDetailResp.getPost().getShare_url(),getResources().getString(R.string.pdetail_share_title),
