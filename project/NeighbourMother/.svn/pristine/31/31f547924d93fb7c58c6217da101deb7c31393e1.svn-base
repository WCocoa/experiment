...
//    private ImageView       environment_image3;
    ...
    private List<String>       educationImages;

    private RelativeLayout rl_teacher_certification;//教师资格证
    private RelativeLayout rl_education_certification;//学历
...
//        environment_image1 = (ImageView) findViewById(environment_image1);
...
//        environment_image3 = (ImageView) findViewById(R.id.environment_image3);
        ...
        rl_teacher_certification = (RelativeLayout) findViewById(R.id.rl_teacher_certification);
        rl_education_certification = (RelativeLayout) findViewById(R.id.rl_education_certification);
        initCell();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_choice:
                ...
                break;
//            case environment_image1:
//                lookOver(1);
//                break;
//            case environment_image2:
//                lookOver(2);
//                break;
//            case environment_image3:
//                lookOver(3);
//                break;
    ...
    private void clickEducation_image(List imgs, int index) {
        Intent mIntent = new Intent(this, PhotoViewPagerActivity.class);
        mIntent.putExtra(IntentFinal.INTENT_IMGURL_TO_PHOTOVIEWACTIVITY, new Gson().toJson(imgs.toArray(), new TypeToken<String[]>() {
        }.getType()));
    ...
    private void setData(AttacheDetailResp attacheDetailResp) {
        ...
        if (flag) {
            ...
            if (!TextUtils.isEmpty(attacheDetailResp.getUser_name()) && attacheDetailResp.getUser_name().length() > 1) {
                person_name.setText(nameModify(attacheDetailResp.getUser_name()));
...
//        String arr[] = {attacheDetailResp.getPic_environment_1(), attacheDetailResp.getPic_environment_2(), attacheDetailResp.getPic_environment_3()};
        educationImages = new ArrayList<String>();
        createEnvironmentImage(attacheDetailResp.getPic_environment());
        if (flag) {
            plate_number.setText(attacheDetailResp.getCar_number());
        } else {
        ...
        display(vehicle_image, APIConfig.BASE_IMG_URL + attacheDetailResp.getCar_pic(), R.mipmap.default_img);
...
//        driver_licence.setText(attacheDetailResp.getCar_license_number());
        ...
        if (TextUtils.isEmpty(attacheDetailResp.getPic_teacher())) {
            rl_teacher_certification.setVisibility(View.GONE);
        } else {
            rl_teacher_certification.setVisibility(View.VISIBLE);
            educationImages.add(attacheDetailResp.getPic_teacher());
            display(teacher_certification_img, APIConfig.BASE_IMG_URL + attacheDetailResp.getPic_teacher(), R.mipmap.default_img);
        }
        if (TextUtils.isEmpty(attacheDetailResp.getPic_education())) {
            rl_education_certification.setVisibility(View.GONE);
        } else {
            rl_education_certification.setVisibility(View.VISIBLE);
            display(education_certification_img, APIConfig.BASE_IMG_URL + attacheDetailResp.getPic_education(), R.mipmap.default_img);
            educationImages.add(attacheDetailResp.getPic_education());
        }


//        educationImages[1] = attacheDetailResp.getPic_education();
...
//                    image.setImageResource(images[i]);
                    ...
                    display(image, APIConfig.BASE_IMG_URL + images[i], R.mipmap.default_img);
    ...
    class OnClickEnvironmentImageListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Intent mIntent = new Intent(AttacheDetailsActivity.this, PhotoViewPagerActivity.class);
...
//                    break;
                case 6:
                    intent.putExtra(IntentFinal.INTENT_IMGURL_TO_PHOTOVIEWACTIVITY, APIConfig.BASE_IMG_URL + attacheDetailResp.getCar_pic());
                    break;
                case 7:
                    intent.putExtra(IntentFinal.INTENT_IMGURL_TO_PHOTOVIEWACTIVITY, APIConfig.BASE_IMG_URL + attacheDetailResp.getUser_avatar());
                    break;
            }
            startActivity(intent);
        }
